...
const ArticleSection = () => {
    return (
        <SectionLayout label="Article Section">
            <div className="mx-auto lg:max-w-2xl lg:mx-0 border-b border-gray-300 pb-10">
            ...
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                <EachUtils
                    of={LIST_ARTICLE}
                    render={(item, index) => (
                        <article key={index} className="flex lg:max-w-xl flex-col items-start justify-between">
