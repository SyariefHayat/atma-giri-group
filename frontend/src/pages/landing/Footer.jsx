                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12 items-center mb-12">
                    ...
                    <div className="flex flex-col justify-center lg:justify-end">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="group w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-white hover:text-[#19A7CE] transition-all duration-300 transform hover:scale-110 hover:shadow-lg">
