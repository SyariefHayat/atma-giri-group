    ...
    return (
        <SectionLayout>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0">
                ...
                <p className="mt-2 text-lg/8 text-gray-600">Kenali orang-orang hebat di balik Atma Giri Group. Mereka adalah individu yang berdedikasi untuk menciptakan perubahan positif.</p>
            </div>

            <div className="mx-auto mt-6 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-300 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                <EachUtils
                    of={LIST_TEAM}
                    render={(item, index) => (
                        <article
